...
| Area                  | About                                         | Main Notes |
| --------------------- | --------------------------------------------- | ---------- |
| Fundaments            | The basics                                    |            |
| Discrete Maths        | What theorems are system based on             |            |
| Algebra               | Form equations to solve complex problems      |            |
| Lineal Algebra        | Study of vectors, matrixes and its operations |            |
| Differential Calculus | rates of change and the slopes of curves      |            |
